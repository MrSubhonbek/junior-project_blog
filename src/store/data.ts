...
},
{
    descriptions: {
        ...
        shortText: 'The diseases most commonly seen in travellers are diarrhoea, malaria (if you travel in a malaria-infested area), accidents (when travelling by automobile or swimming), wound infections and…',
        date: '13.02.2021',
        img: "https://",
        hashtag: "#Guides",
    },
...
},
{
    descriptions: {
        id: 2,
        action: 'Travel',
        title: 'From its architecture to its industry and sporting events in London.',
        shortText: 'Coventry is a city of hope, survival and rejuvenation fueled by the passion of its people...',
        date: '25.01.2021',
        img: "https://",
        hashtag: "#Guides",
    },
    articles:
        [
            {
                paragraph: 'From its architecture to its industry and sporting events, this is a city of fascinating contrasts just an hour by train from London.',
                text: [
